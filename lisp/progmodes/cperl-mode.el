...
(defcustom cperl-electric-parens-mark t
...
(easy-menu-define cperl-menu cperl-mode-map
  ...
  '("Perl"
    ...
    "----"
    ["Line up a construction" cperl-lineup mark-active]
    ...
    "----"
    ["Indent region" cperl-indent-region mark-active]
    ["Comment region" cperl-comment-region mark-active]
    ["Uncomment region" cperl-uncomment-region mark-active]
    "----"
    ["Debugger" cperl-db t]
    "----"
    ("Tools"
