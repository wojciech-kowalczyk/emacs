...
(easy-menu-define
  ...
  `("System"
    ...
    ["Consult buffer" prolog-consult-buffer
     :included (not (eq prolog-system 'mercury))]
    ["Consult region" prolog-consult-region :active mark-active
     :included (not (eq prolog-system 'mercury))]
    ...
    ["Compile buffer" prolog-compile-buffer
     :included (eq prolog-system 'sicstus)]
    ["Compile region" prolog-compile-region :active mark-active
     :included (eq prolog-system 'sicstus)]
...
(easy-menu-define
  ...
  '("Prolog"
    ...
    ["Convert variables in region to '_'" prolog-variables-to-anonymous
     :active mark-active :included (not (eq prolog-system 'mercury))]
    "---"
    ...
    ["Align region" align mark-active]
    "---"
