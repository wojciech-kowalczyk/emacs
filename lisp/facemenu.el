...
;; change the region to use that face.  If the region is not active,
;; the face will be remembered and used for the next insertion.
;; It will be forgotten if you move point or make other
