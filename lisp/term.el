...
If `data-directory' is accessible to subprocesses,
return the same and no more.  Otherwise, copy terminfo files
...
Return nil if this is Windows, where serial ports have
