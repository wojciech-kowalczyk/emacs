...
;; is nil (don't insert).
;;
;; If you're using Emacs for Windows, don't forget to
...
On Windows, a string value is taken as the name of the
...
On Windows, if `print' is in use, this should be
the string \"/D:\".
...
On Windows, if the value is an empty string then Emacs
