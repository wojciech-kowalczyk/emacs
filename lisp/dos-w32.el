...
dealing with untranslated filesystems."
  (if (memq system-type '(windows-nt cygwin))
      ;; The canonical form for W32 is with A-Z downcased and all
...
;;; Support for printing under Windows, see lpr.el and ps-print.el.
...
(defun w32-direct-print-region-function (start end
                                               ...
                                               &rest rest)
  "Windows-specific function to print the region on a printer.
...
(defun w32-direct-ps-print-region-function (start end
                                                  ...
                                                  delete-text buf display
                                                  &rest rest)
  "Windows-specific function to print the region on a PostScript printer.
Writes the region to the device or file which is a value of
