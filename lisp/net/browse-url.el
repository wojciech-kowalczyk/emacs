...
(defcustom browse-url-text-emacs-args nil
...
If the mark is active, it defaults to the current region, else to the URL
at or before point.  If invoked with a mouse button, it moves point to the
...
instead."
  ...
  (list (read-string prompt (or (and mark-active
				     ;; rfc2396 Appendix E.
